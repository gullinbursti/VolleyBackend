...
class BIM_Push{
    ...
    public static function pushCreators( $volleys ){
        ...
        $msg = "Your Selfie had made it to the top of the Explore section! Tap or swipe to view.";
    ...
    public static function emailVerifyPush( $userId ){
        ...
        $msg = "Selfieclub on! Your Selfieclub account has been verified!";
        self::send( $user->device_token, $msg );
    }
    ...
    public static function doVolleyAcceptNotification( $volleyId, $targetId ){
        ...
        $msg = "@$targetUser->username has joined the Selfieclub conversation: $volleyObject->subject";
        $pushType = 6;
