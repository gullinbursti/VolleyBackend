...
--
-- Table structure for table `tblChallengeParticipantSubjectMap`
--

DROP TABLE IF EXISTS `tblChallengeParticipantSubjectMap`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `tblChallengeSubjectMap`
--

DROP TABLE IF EXISTS `tblChallengeSubjectMap`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `tblChallengeSubjects` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(1023) CHARACTER SET latin1 NOT NULL DEFAULT '',
  `creator_id` int(10) unsigned NOT NULL,
  `itunes_id` varchar(255) NOT NULL,
  `linkshare_url` varchar(255) NOT NULL,
  `emoticon_url` varchar(255) NOT NULL DEFAULT '',
  `added` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `title` (`title`(767))
) ENGINE=InnoDB AUTO_INCREMENT=10003873 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=98656 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tblChallenges` (
  ...
  KEY `club_id` (`club_id`)
) ENGINE=InnoDB AUTO_INCREMENT=253034 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tblClubTypeEnum`
--

DROP TABLE IF EXISTS `tblClubTypeEnum`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `tblUserPhones`
--
...
CREATE TABLE `tblUserPhones` (
  ...
  `verify_last_attempt` datetime DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=134058 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-06-26 18:27:05
